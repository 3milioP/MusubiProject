...
var Popper = React48.forwardRef(function Popper2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime50.jsx)(Portal_default, {
    disablePortal,
    container,
    children: (0, import_jsx_runtime50.jsx)(PopperTooltip, _extends({
      anchorEl,
      direction,
      disablePortal,
      modifiers,
...
var Cancel_default = createSvgIcon((0, import_jsx_runtime59.jsx)("path", {
...
var Chip = React58.forwardRef(function Chip2(inProps, ref) {
  ...
  if (onDelete) {
    ...
    }) : (0, import_jsx_runtime60.jsx)(Cancel_default, {
  ...
  return (0, import_jsx_runtime61.jsxs)(ChipRoot, _extends({
    as: component,
    className: clsx_default(classes.root, className),
    ...
    children: [avatar || icon, (0, import_jsx_runtime60.jsx)(ChipLabel, {
...
//# sourceMappingURL=chunk-IQK5Z5AI.js.map
